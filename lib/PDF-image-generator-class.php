...
class PDF_Image_Generator {
    ...
    private function PDFIG_get_settings($option) {
        $PDFIG_option_val = (isset($_SESSION[PDFIG_SETTINGS][$option]) &&  $_SESSION[PDFIG_SETTINGS][$option])? $_SESSION[PDFIG_SETTINGS][$option] : get_option(PDFIG_SETTINGS)[$option];
