...
<div class="wrap PDF-image-settings">
    ...
    <p><?php echo __('Download Wkhtmltox from', 'PDFIG') . ' ' . '<a href="https://wkhtmltopdf.org/downloads.html" target="_blank">' . __('here', 'PDFIG') . '</a>' . ' ' . __('and enter the absolute path of the downloaded files in the below fields.', 'PDFIG'); ?></p>
